    ...
    for i, tile in enumerate(cut.get("tiles") or [], 1):
        ...
        if hdr:
            if source_is_hdr:
                ...
                # HDR 화면의 SDR reference white(203nit)를 HLG 1000nit 신호의
                # 20.3% 선형광에
                ...
                chain += [f"setparams=range={source_range}:"
                          ...
                          "lutrgb=r='val*0.203':g='val*0.203':b='val*0.203'",
...
const renderHdr=document.querySelector('#renderHdr');renderHdr.checked=localStorage.getItem('jiho.render.hdr.v2')==='true';renderHdr.onchange=()=>localStorage.setItem('jiho.render.hdr.v2',String(renderHdr.checked));
